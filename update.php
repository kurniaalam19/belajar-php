...
if (isset($_POST['submit'])){
    ...
    $sql = "UPDATE mahasiswa SET nim='$nim',nama='$nama',id_jurusan='$id_jurusan',tempat_lahir='$tmpt_lahir',
...
<body>
    ...
    <form action="" method="post">
        ...
        Tempat Lahir: <input type="text" name="tmpt_lahir" value="<?php echo $tmpt_lahir; ?>"><br>
